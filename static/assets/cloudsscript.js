...
cloud0fore.src = "static/assets/cloud0-fore.png";

var cloud1fore = new Image();
cloud1fore.src = "static/assets/cloud1-fore.png";

var cloud2fore = new Image();
cloud2fore.src = "static/assets/cloud2-fore.png";

var cloud3fore = new Image();
cloud3fore.src = "static/assets/cloud3-fore.png";

var cloud0mid = new Image();
cloud0mid.src = "static/assets/cloud0-mid.png";

var cloud1mid = new Image();
cloud1mid.src = "static/assets/cloud1-mid.png";

var cloud2mid = new Image();
cloud2mid.src = "static/assets/cloud2-mid.png";

var cloud3mid = new Image();
cloud3mid.src = "static/assets/cloud3-mid.png";

var cloud0back = new Image();
cloud0back.src = "static/assets/cloud0-back.png";

var cloud1back = new Image();
cloud1back.src = "static/assets/cloud1-back.png";

var cloud2back = new Image();
cloud2back.src = "static/assets/cloud2-back.png";

var cloud3back = new Image();
cloud3back.src = "static/assets/cloud3-back.png";
